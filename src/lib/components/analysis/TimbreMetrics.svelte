	...
	<div class="space-y-3">
		<div>
			...
			<div class="progress-bar-sm">
				<div
					class="progress-bar-sm-fill {getBarColor(brightnessNormalized)}"
		...
		<div>
			...
			<div class="progress-bar-sm">
				<div
					class="progress-bar-sm-fill {getBarColor(breathiness)}"
		...
		<div>
			...
			<div class="progress-bar-sm">
				<div
					class="progress-bar-sm-fill {getBarColor(rolloffNormalized)}"
		...
		<div>
			...
			<div class="progress-bar-sm">
				<div
					class="progress-bar-sm-fill {getBarColor(crestNormalized)}"
		...
		<div>
			...
			<div class="progress-bar-sm">
				<div
					class="progress-bar-sm-fill {getBarColor(slopeNormalized, true)}"
		...
		<div>
			...
			<div class="progress-bar-sm">
				<div
					class="progress-bar-sm-fill {getBarColor(zcrNormalized)}"
